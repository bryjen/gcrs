...
use islands::{RepoLanguageBar, RepoOverview};
...
pub fn Repo() -> impl IntoView {
    ...
    view! {
        <div class="flex flex-col gap-6 py-12 pt-8 pb-[50vh]">
            ...
            <div id="repo-contents" class="grid grid-cols-[minmax(0,72.5fr)_minmax(0,27.5fr)] gap-12">
                <RenderMain />
                <RenderSidePanel />
            </div>
...
fn RenderMain() -> impl IntoView {
    ...
    view! {
        <div class="w-full max-w-full min-w-0 flex flex-col gap-6">
    ...
    view! {
        <div class="flex flex-col gap-4 w-full min-w-0">
            <div class="flex flex-col gap-4 min-w-0">
                ...
                <div class="flex flex-row flex-wrap gap-2 my-2 min-w-0">
                    <For
                        each=move || 1..=10
                        key=|i| *i
